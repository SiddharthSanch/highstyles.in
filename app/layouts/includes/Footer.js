    ...
    <div className="flex flex-col">
          ...
          <div className="flex w-full flex-col ">
            <div className="flex justify-center sm:flex-row flex-col gap-[6rem]">
              <div className="flex sm:flex-row flex-col gap-[4rem]">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d448196.52633258584!2d76.76357436215976!3d28.643684626335453!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd5b347eb62d%3A0x37205b715389640!2sDelhi!5e0!3m2!1sen!2sin!4v1708580250099!5m2!1sen!2sin"
                  width="sm:400"
                  height="300"
                  // style="border:0;"
      ...
      <div className="bg-[#202020] flex sm:flex-row flex-col h-auto w-full text-[#b1b1b1] gap-6 p-3">
        <div className="sm:w-1/2 flex items-center justify-center h-full ">
          <h1 className="flex items-center">2024 Highstyles &nbsp;<Copyright size={16}/> &nbsp;All Rights Reserved</h1>
        </div>
        <div className="sm:w-1/2 flex items-center justify-center h-full ">
        ...
        <div className="sm:w-1/2 flex items-center justify-center h-full cursor-pointer ">
          <div className="sm:px-4 flex sm:flex-row flex-col gap-8  w-full items-center justify-center">
            <div onClick={()=>router.push("/terms-and-conditions")}>Terms&nbsp;&&nbsp;Conditions</div>
