  ...
  const handleSubmitViaEP = async () => {
    try {
      ...
      if (error) {
        ...
        console.log(user);
        if (user.id == "14479371-5a4f-4d09-9154-7172bdf8c5f8") {
          ...
          toast.error("You are not authorized to access this page",toastsettings);
        }
      }
    } catch (error) {
    ...
    <div className="flex justify-center items-center w-screen h-screen">
      <div className="flex flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 flex flex-col items-center gap-8 py-17.5 text-center">
        ...
        <div className="w-full border-stroke xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <h2 className="mb-9 text-2xl font-bold text-black  sm:text-title-xl2">
              Sign In to Admin Highstyles.in
            </h2>
