...
const Testimonials = () => {
  ...
  return (
      <div className="flex flex-col sm:mt-0 px-6 py-3 gap-5 items-center sm:h-screen justify-center">
        ...
        <div
          className="flex justify-center absolute w-full top-[-5rem] mt-4 text-2xl sm:text-[4.5rem] z-50"
          style={{
            opacity: 0.1,
          }}
        >
        ...
        <div className="text-[2.5rem] mt-[1.5rem] z-50 different">
        ...
        <div className="flex justify-center">
          <h1 className="text-gray-500 text-xl transition-opacity duration-500">
            Discover the impact Highstyles.in has had on the lives and careers of our
            community members.
          </h1>
        </div>
        <div className="flex sm:h-[13rem] justify-center sm:px-[12rem] mt-[3rem] transition-opacity duration-500">
          ...
          >
            ...
            <div className="justify-center  items-center flex mt-6">
              <Image src={testimonials[currentIndex].image} alt="image" width={35} className="rounded-full" />
              &nbsp;&nbsp;
              <span className=" ">{testimonials[currentIndex].name}</span>
              <br />&nbsp;&nbsp;
              <span className="text-2xl">|</span>&nbsp;&nbsp;
              <h1 className="text-gray-500">{testimonials[currentIndex].designation}</h1>
            </div>
          </div>
        </div>
